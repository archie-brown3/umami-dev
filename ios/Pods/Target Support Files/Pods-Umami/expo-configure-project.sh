...
with_node \
  ...
  --target "/Users/archiebrown/Documents/umami-dev/ios/Pods/Target Support Files/Pods-Umami/ExpoModulesProvider.swift" \
   \
  --platform "apple" \
  --packages "expo" "expo-application" "expo-asset" "expo-blur" "expo-constants" "expo-file-system" "expo-font" "expo-haptics" "expo-image-picker" "expo-keep-awake" "expo-linking" "expo-network" "expo-router" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-web-browser"
